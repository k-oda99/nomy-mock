...
export type GetGroupIdsQuery = {
  __typename?: 'query_root'
  groups: Array<{ __typename?: 'groups'; id: any }>
}
 ...
 * });
 */
export function useGetGroupIdsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetGroupIdsQuery,
    GetGroupIdsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetGroupIdsQuery, GetGroupIdsQueryVariables>(
    GetGroupIdsDocument,
    options
  )
}
export function useGetGroupIdsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetGroupIdsQuery,
    GetGroupIdsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetGroupIdsQuery, GetGroupIdsQueryVariables>(
    GetGroupIdsDocument,
    options
  )
}
export type GetGroupIdsQueryHookResult = ReturnType<typeof useGetGroupIdsQuery>
export type GetGroupIdsLazyQueryHookResult = ReturnType<
  typeof useGetGroupIdsLazyQuery
>
export type GetGroupIdsQueryResult = Apollo.QueryResult<
  GetGroupIdsQuery,
  GetGroupIdsQueryVariables
>
