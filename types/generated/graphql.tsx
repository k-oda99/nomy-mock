...
/** on conflict condition type for table "profiles_users" */
...
export type GetGroupsQuery = { __typename?: 'query_root', groups: Array<{ __typename?: 'groups', id: any, name: string, users: Array<{ __typename?: 'users', age?: string | null, id: any, image?: string | null, job?: string | null, name: string }> }> };
...
export type GetGroupByIdQuery = { __typename?: 'query_root', groups_by_pk?: { __typename?: 'groups', id: any, name: string } | null };

export type GetGroupIdsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetGroupIdsQuery = { __typename?: 'query_root', groups: Array<{ __typename?: 'groups', id: any }> };
...
export const GetGroupIdsDocument = gql`
    query GetGroupIds {
  groups {
    id
  }
...
/**
 * __useGetGroupIdsQuery__
 *
 * To run a query within a React component, call `useGetGroupIdsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetGroupIdsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetGroupIdsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetGroupIdsQuery(baseOptions?: Apollo.QueryHookOptions<GetGroupIdsQuery, GetGroupIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetGroupIdsQuery, GetGroupIdsQueryVariables>(GetGroupIdsDocument, options);
      }
export function useGetGroupIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetGroupIdsQuery, GetGroupIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetGroupIdsQuery, GetGroupIdsQueryVariables>(GetGroupIdsDocument, options);
        }
export type GetGroupIdsQueryHookResult = ReturnType<typeof useGetGroupIdsQuery>;
export type GetGroupIdsLazyQueryHookResult = ReturnType<typeof useGetGroupIdsLazyQuery>;
export type GetGroupIdsQueryResult = Apollo.QueryResult<GetGroupIdsQuery, GetGroupIdsQueryVariables>;